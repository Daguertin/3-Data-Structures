...
class Account {
    ...
    const joey = new Account
    console.log(joey)
    const julia = new Account("Julia", 234322234, 50)
    console.log(julia)

// If you need to edit code that could impact lots of people
// Its a bad idea... so how, consider below
/*  
    ? Class Inheritance
...
//allows us to access properties and methods of a parent class
        super(name, ssn, balance) //what we are bringing in
...
// This is using the edited code from the child and parent above
// you do not manipulate the actual code, you adjust a super and pass parameters on
...
// IT is risky to modify the original constructor
// so instead, wrap it with a function and push a new instance of a constructor
// we did need a raidius, so we used a new return and got a diameter/2
